...
export const SOINS = [
  {
    ...
    icon: "ShieldCheck",
    shortDesc: "Prévention et traitement des gencives pour préserver le soutien de vos dents.",
  ...
  },
  {
    ...
    icon: "Shield",
    shortDesc: "Des soins conservateurs pour préserver au maximum vos dents naturelles.",
  ...
  },
  {
    ...
    title: "Prothèses",
    icon: "Crown",
    shortDesc: "Des solutions sur mesure pour remplacer ou restaurer les dents manquantes ou fragilisées.",
  ...
  },
  {
    ...
    icon: "Radio",
    shortDesc: "Des examens d'imagerie pour un diagnostic précis et rapide.",
  ...
  },
  {
    ...
    title: "Chirurgie",
    icon: "Stethoscope",
    shortDesc: "Des actes chirurgicaux réalisés avec précision et en toute sécurité.",
  ...
  },
  {
    ...
    icon: "AlertCircle",
    shortDesc: "Prise en charge rapide des douleurs et traumatismes dentaires.",
