...
const BlogArticleClient = ({ article }: { article: Article }) => (
  <>
    <section className="bg-primary pt-20 pb-12 md:pt-[7.5rem] md:pb-15">
      <div className="container max-w-3xl">
        <Link href="/blog" className="text-accent text-sm font-medium inline-flex items-center gap-1 mb-4 hover:underline">
